    ...
    return h(this, undefined, undefined, function () {
      var e, r, n, o, i, a, s, c, u, l, p, d, h, f, v, y, m, w, g, b, _, x, A, q;return S(this, function (t) {
        switch (t.label) {case 0:
            ...
            return p = k(u, ["data", "model", n], {}), d = p.url, h = undefined === d ? "" : d, f = p.formData, v = undefined === f ? null : f, y = p.headers, (m = { url: h, fileType: n, header: undefined === y ? null : y, formData: v, filePath: e, fileName: "file" }).header && m.header.Authorization && (m.formData.Authorization = m.header.Authorization), i && (m.formData.localFileName = Date.now() + "-" + function (t) {
              if (!t) return "file";var e = t.lastIndexOf("/");return 0 <= e ? t.substr(e + 1) : t;
            }(i)), m.header ? "image" !== n && (m.header.origin = m.header.origin || "https://miniapp-cloud.taobao.com", m.header.referer = m.header.referer || "https://miniapp-cloud.taobao.com") : delete m.header, m.formData || delete m.formData, [4, this.storageRequest("my.uploadFile", m)];case 5:
